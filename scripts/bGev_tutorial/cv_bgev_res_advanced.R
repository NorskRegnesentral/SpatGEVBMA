...
res=fread("/nr/samba/user/roksvag/GitRepo/SpatGEVBMA/scripts/bGev_tutorial/inlares_advanced.csv")
...
#fwrite(allres,"/nr/samba/user/roksvag/GitRepo/SpatGEVBMA/scripts/bGev_tutorial/retlevel_res_advanced.csv")

allres=fread("/nr/samba/user/roksvag/GitRepo/SpatGEVBMA/scripts/bGev_tutorial/retlevel_res_advanced.csv")
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//precip_JJA.pdf",width = 8, height = 4)
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//temp_JJA.pdf",width = 8, height = 4)
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//wetterdays_JJA.pdf",width = 8, height = 4)
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//lon.pdf",width = 8, height = 4)
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//lat.pdf",width = 8, height = 4)
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//masl.pdf",width = 8, height = 4)
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//intercept.pdf",width = 8, height = 4)
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//spatrange.pdf",width = 8, height = 4)
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//spatsig.pdf",width = 8, height = 4)
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//spread_intercept.pdf",width = 8, height = 4)
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//spread_lon.pdf",width = 8, height = 4)
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//spread_lat.pdf",width = 8, height = 4)
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//tail_intercept.pdf",width = 8, height = 4)
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//tail_lon.pdf",width = 8, height = 4)
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//tail_lat.pdf",width = 8, height = 4)
...
pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//mu.pdf",width = 8, height = 4)
ggplot(gevparams,aes(x=year,y=mu,col=year_specific))+geom_point()+geom_hline(yintercept=0,lty=2)+facet_wrap(~year_specific)
dev.off()

pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//sig.pdf",width = 8, height = 4)
ggplot(gevparams,aes(x=year,y=sigma,col=year_specific))+geom_point()+geom_hline(yintercept=0,lty=2)+facet_wrap(~year_specific)
dev.off()

pdf(file = "/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/params//xi.pdf",width = 8, height = 4)
...
for(k in 1:(dim(uniquelocs)[1])){
  ...
  pdf(file = paste0("/nr/project/stat/Impetus4Change/Dev_Thea/Figs/AdvancedTailSpread/locyear/locnum",k,".pdf"),width = 12, height = 10)
  par(mfrow=c(3,3))
