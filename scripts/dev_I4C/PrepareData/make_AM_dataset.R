...
AM60=fread("Data/AMnorway/AM_720_min_all_plu_act_and_end_06_10_2020_v02.txt",dec=",")
...
elev=fread("Data/AMnorway/elevlonlat.csv",dec=".")
...
fwrite(AM60,file="Data/AM720.csv")
