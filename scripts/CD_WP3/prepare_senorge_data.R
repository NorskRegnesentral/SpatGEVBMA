...
clim_years=1971:2021 #1991:2020,#1971:2022 (clim 2)
type="inference"

#---------------------------------------------------------------------------------------#

#JJA temp:
nc=nc_open(paste0("raw/senorge/seNorge_1957-2021.JJAtemp.nc"))
...
#MAP
nc=nc_open(paste0("raw/senorge/seNorge_1957-2021.MAP.nc"))
lon=ncvar_get(nc,"lon")
lat=ncvar_get(nc,"lon")
Xc=ncvar_get(nc,"X")
Yc=ncvar_get(nc,"Y")
...
#MSP
nc=nc_open(paste0("raw/senorge/seNorge_1957-2021.MSP.nc"))
lon=ncvar_get(nc,"lon")
lat=ncvar_get(nc,"lon")
Xc=ncvar_get(nc,"X")
Yc=ncvar_get(nc,"Y")
...
#MSP.JJA
nc=nc_open(paste0("raw/senorge/seNorge_1957-2021.MSPJJA.nc"))
lon=ncvar_get(nc,"lon")
lat=ncvar_get(nc,"lon")
Xc=ncvar_get(nc,"X")
Yc=ncvar_get(nc,"Y")
...
#wetDays
nc=nc_open(paste0("raw/senorge/seNorge_1957-2021.wetDays.nc"))
lon=ncvar_get(nc,"lon")
lat=ncvar_get(nc,"lon")
Xc=ncvar_get(nc,"X")
Yc=ncvar_get(nc,"Y")
